                ...
                <Col className='p-0' xs={12}>
                    <Row class>
                        ...
                        <Col className='p-0' xs={4}>
                            <Row classN>
                                <Col className='p-0' style={{ marginLeft: "-10px" }}><FontAwesomeIcon size='2x' icon={faSun} color='#F7DB4E' /></Col>
                                <Col className='pl-0 text-end' style={{ marginRight: '10px' }}><FontAwesomeIcon size='2x' icon={faCanadianMapleLeaf} color="#D85B32" /></Col>
                            </Row>
                        </Col>
                    </Row>
                </Col>
